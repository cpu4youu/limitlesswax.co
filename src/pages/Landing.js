...
const Landing = () => {
    ...
    const handleExpandedChange = (index) => {
        setExpanded([...expanded.slice(0, index), !expanded[index], ...expanded.slice(index + 1, expanded.length)]);
    }
    ...
    return (
        <Container sx={{
            ...
            <Box sx={{
                ...
                <Box sx={{
                    ...
                    <Typography sx={{
                        ...
                        <span style={{ wordBreak: 'break-all' }}> deposits/withdraws/rents/returns </span> wax.
                    </Typography>
                    <Typography sx={{
                        fontWeight: '300',
                        fontSize: 24,
            ...
            <Typography sx={{
                ...
                The system will be open for 1 week before allowing users to deposit their own wax to earn.
                If users find bugs there is a bug bounty program on discord.
            </Typography>
            <Box sx={{
                display: 'flex',
                flexWrap: 'wrap',
                ...
                <Box sx={{
                    ...
                    <Typography className={classes.cardText}>
                        The system dynamically creates a price for the staked wax given the current supply, total loaned out, number of days,
                        and amount user requests. Then that wax is sent to a minion account and staked to the user for the given time.
                    </Typography>
                </Box>
                <Box sx={{
                    width: { xs: '100%', md: 'calc(50% - 5px)' },
                    ...
                    <Box sx={{
                        ...
                        <Typography className={classes.cardText}>
                            As long as this account has wax it will send in a specified amount to the main contract requesting cpu as
            ...
            <Box sx={{
                ...
                <Box sx={{
                    ...
                    <Box sx={{
                        ...
                        <Typography className={classes.cardText}>
                            Similar to requesting to yourself, this does the first few steps but then directly stakes to the user specified.
                ...
                <Box sx={{
                    ...
                    <Typography className={classes.cardText}>
                        ...
                        If there is not enough liquid wax, as more gets unstaked it will be sent in order to users in line to withdraw.
                    </Typography>
                </Box>
            </Box>
            <Box sx={{
                    ...
                    >
                        ...
                        >
                            <AccordionSummary sx={{ 
                                ...
                                {expanded[key] ? (
                                    <RemoveIcon sx={{ fontSize: { xs: '20px', md: '36px' }, color: '#F0F0F0' }} />
                                ) : (
                                    <AddIcon sx={{ fontSize: { xs: '20px', md: '36px' }, color: '#F0F0F0' }} />
                                )}
